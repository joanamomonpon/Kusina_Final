...
<br><br><br>
		...
		<input id="prices" type="number" class="form-control form-control-sm" name="price" placeholder="price" value="<?php echo $price;?>" readonly>
				...
				<br><br>
					<div class="col-4">	
						<label>quantity</label>
							<input type="text" class="form-control form-control-sm" name="quantity" placeholder="qty" style="width: 100px;" required>
					</div>
			</div>
	</div>
</br></br></br>				
				<div class="row">		
					<?php $customer_id = $_GET['no']; ?>
						<div class="col-2">
							  <button type="submit" name="submit" class="btn btn-info btn-sm">Add Menu</button>
						</div>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<div class="col-2">
	...
	<div class="col-6">
		...
		<tbody>
			...
			<tr>
				...
				<td><button type ="submit" class="btn btn-primary btn-sm"><a href="viewOrdersalesDel.php?id=<?php echo $row["menu_id"];?>&order_id=<?php echo $row["order_id"];?>"> Delete </a></button></td>
				</tr>
	<?php		
			}
		}
	?>
			...
			<br><br>
		<div align="left">
			<u><b><h1>TOTAL </h1></u><h1>&#8369;<?php echo $total;?>.00</h1></b><center>
		</div>	
		</div>
	</div>
</div>

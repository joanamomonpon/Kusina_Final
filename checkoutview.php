			...
			<div class="col-8">
				...
				?>
							...
							Customer Name : <b><?php echo $row["first_name"]; ?></b>
										...
										?>
										<button class="btn btn-light" style="float: right"><a href="orderviewcus.php"> Finish </a></button>
										<button class="btn btn-light" style="float:right;margin-right: 10px"><a href="orderadd.php?order=<?php echo $order_id; ?>&no=<?php echo $customer_id; ?>">Edit Orders</a></button><br><br>

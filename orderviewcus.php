		...
		<div class="row">
			...
			<form action = "search.php" method="GET" >
				<div class="row">
					...
					<button class="btn btn-warning"><a href="order_reports.php"> Reset</a></button>
				</div>
			</form>
			<form><br>
				<button type="submit" name="cancel" class="btn btn-warning"><a href="CustomerOrder.php"><i class="fas fa-plus-circle    "></i>Add Orders</a></button>
					<br/><br/>
				...
				<table class="table table-dark">
				  ...
				  <tbody>
					...
					<tr>
					  ...
					  <td>&#8369; <?php echo $sum;?></td>
					  <td> <button type ="submit" class="btn btn-light btn-sm"><a href="checkout.php?order=<?php echo $order_id; ?>&no=<?php echo $customer_id; ?>">View</a></button></td>
							...
							<tr>
								<td>
									...
									<div class="dropdown">
										...
										<div class="dropdown-content">	
											<a href="orderviewcus.php">View Orders</a>
										</div>
									</div>

<?php
	...
	if (isset($_POST['submit'])) {
		...
		echo $id;
		$mysqli->query("INSERT INTO customer (id, customer_id, first_name, last_name, middle_initial, pnumber, province, street, barangay, city) VALUES($id, $customer_id, '$first_name', '$last_name', '$middle_initial', '$pnumber', '$province', '$street', '$barangay', '$city')") or die($mysqli->error);

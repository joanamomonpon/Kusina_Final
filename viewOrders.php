...
<html lang="en-US">
	...
	<body>
		<div class="row" style="background-color:#2F4F4F">
			<div style="background-image: url('cover.jpg');background-size: contain; height: 400px;background-repeat: no-repeat;position: relative" class="col-8">
				<div id="profile">
				...
				<form style="position: absolute;bottom: 5px" action = "viewOrdersalespro.php" method="GET">
					<div class="row">
						<?php
							$order_id = $_GET['order'];
						?>
					...
					<div class="row">		
						...
						<div class="col-2">
							  <button class="btn btn-light btn-sm"><a href="checkoutview.php?order=<?php echo $order_id; ?>&no=<?php echo $customer_id; ?>">Done</a></button>
						</div>
								<script>
